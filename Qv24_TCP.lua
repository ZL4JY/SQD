...
--    f_command = ProtoField.uint16("QV24T.command", "Command", base.HEX),
--    f_data = ProtoField.string("QV24T.data", "Data", FT_STRING)
}
-- 
p_QV24T.fields = hdr_fields
    ...
    while bytes_consumed < pktlen do
        ...
        if stun_payload_tvbr:len() >= 2 then
            ...
            if stun_payload_tvbr:len() > 2 then
                ...
                pkt.cols.protocol:set(p_QV24T.name)
                local tree = root:add(p_QV24T, p25_tvbr)
